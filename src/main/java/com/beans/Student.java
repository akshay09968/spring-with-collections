...
public class Student {
	...
	public void PrintStudentInfo() {
		...
		System.out.println("Student qualification: "+this.getQualification());
		System.out.println("Student courses: "+this.getCourses());
		System.out.println("Student courses and faculty: "+this.getCourse_and_faculty());
		System.out.println("Student courses and cost: "+this.getCourse_and_cost());
	}
}
